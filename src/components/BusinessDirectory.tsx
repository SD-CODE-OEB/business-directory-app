...
import { getBusinessesByCategory, getBusinessById, searchBusinesses, getFeaturedBusinesses } from '../utils';
...
const BusinessDirectory: React.FC = () => {
    ...
    const [sortOption, setSortOption] = useState<'rating' | 'name' | 'reviews'>('rating');
    ...
    const sortBusinesses = <T extends { rating: number; name: string; reviewCount: number }>(businessList: T[]): T[] => {
    ...
    const PaginationControls = ({ totalItems }: { totalItems: number }) => {
        ...
        return (
            <div className="flex justify-center mt-8 space-x-2">
                <button
                    className={`px-4 py-2 rounded-md ${pageNumber === 1 ? 'bg-gray-200 text-gray-500 cursor-not-allowed' : 'bg-blue-600 text-white hover:bg-blue-700'}`}
                ...
                <div className="flex items-center space-x-1">
                    {[...Array(totalPages)].map((_, i) => (
                        <button
                            key={i}
                            className={`w-10 h-10 rounded-md ${pageNumber === i + 1 ? 'bg-blue-600 text-white' : 'bg-gray-200 hover:bg-gray-300'}`}
                ...
                <button
                    className={`px-4 py-2 rounded-md ${pageNumber === totalPages ? 'bg-gray-200 text-gray-500 cursor-not-allowed' : 'bg-blue-600 text-white hover:bg-blue-700'}`}
            ...
            <div className="flex flex-wrap items-center gap-4">
                ...
                <div className="flex space-x-2">
                    <button
                        ...
                        className={`px-3 py-1 rounded ${sortOption === 'rating' ? 'bg-blue-600 text-white' : 'bg-gray-200 hover:bg-gray-300'}`}
                    >
                        Rating
                    </button>
                    <button
                        onClick={() => handleSortChange('name')}
                        className={`px-3 py-1 rounded ${sortOption === 'name' ? 'bg-blue-600 text-white' : 'bg-gray-200 hover:bg-gray-300'}`}
                    >
                        Name
                    </button>
                    <button
                        onClick={() => handleSortChange('reviews')}
                        className={`px-3 py-1 rounded ${sortOption === 'reviews' ? 'bg-blue-600 text-white' : 'bg-gray-200 hover:bg-gray-300'}`}
                    >
                        Review Count
                    </button>
                </div>
                ...
                <section className="mb-12">
                    ...
                    <div className="rounded-none p-6 mb-8">
                        <div className="text-left mb-6">
                            <h3 className="text-xl font-semibold">Highest Rated Local Favorites</h3>
                            <p className="">Discover exceptional businesses loved by the community</p>
                        </div>
    ...
    const renderCategoryPage = () => {
        ...
        const allCategoryBusinesses = getBusinessesByCategory(selectedCategoryId || '');
                ...
                <div className="mb-8">
                    ...
                    <div className="flex items-center">
                        ...
                        <div>
                            ...
                            <p className="text-gray-600">{allCategoryBusinesses.length} businesses</p>
                        </div>
                    </div>
                </div>
    ...
    return (
        <div className="min-h-screen flex flex-col bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100" ref={mainRef}>
